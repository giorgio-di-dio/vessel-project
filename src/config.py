...
UNET_FEATURES = [64, 128, 256, 512]  # features=[16, 32, 64, 128] con rete "piccola",   [64, 128, 256, 512] con rete "grande"
RANDOM_SEED = 43                   # Configurazione del seed per la riproducibilità
